...
//Class 2.13
function mark_mission_metabox_options($metaboxes) {
    $section_id = 0;
            ...
            array(
                ...
                'fields' => array(
                    array(
                        ...
                        'default' => __('Here We Are x','mark')
                    ),
                    array(
                        'id' => 'sub-heading',
                        'type' => 'text',
                        'title' => __('Mission Sub-Heading','mark'),
                        'default' => __('Our mission is very simple. we just wanna dominate our space x','mark')
                    ),
                    array(
                        'id' => 'description',
                        'type' => 'wysiwyg',
...
add_filter('cs_metabox_options','mark_mission_metabox_options');
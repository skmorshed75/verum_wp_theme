...
<head>
    ...
    <link href="assets/vendor/bicon/css/bicon.css" rel="stylesheet">

    <!--woocommerce css-->
    <!--<link rel="stylesheet" href="assets/css/woocommerce-prev.css">-->

    <link rel="stylesheet" href="assets/css/woocommerce-layouts.css">
                            ...
                            <nav class="woocommerce-MyAccount-navigation">
                                <ul>
                                    ...
                                    <li class="woocommerce-MyAccount-navigation-link woocommerce-MyAccount-navigation-link--customer-logout">
                                        <a href="login-registration.html">Logout</a>
                                    </li>
                                </ul>
                            </nav>

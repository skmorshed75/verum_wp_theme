...
class VerumSocialIcons_widget extends WP_Widget {
	...
	public function form($instance) {
		if(isset($instance['title'])) {
			...
			$title = __('Social Icons', 'verum-companion');
		}
	...
	<p>
		<label for="<?php echo esc_attr($this->get_field_id('classname')) ?>"><?php _e('CSS Class name','verum-companion') ?></label>
		<input class="widefat" 
...
function verumc_social_icons_widget(){
	register_widget('VerumSocialIcons_widget');
}

add_action('widgets_init', 'verumc_social_icons_widget');